    ...
    extends Service
{
    ...
    private final static QName FUNCTIONSERVICE_QNAME = new QName("http://com/", "FunctionService");
    ...
    public Function getFunctionPort() {
        return super.getPort(new QName("http://com/", "FunctionPort"), Function.class);
    }
    ...
    public Function getFunctionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://com/", "FunctionPort"), Function.class, features);
    }
