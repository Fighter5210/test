...
public class Sm4Util {
    ...
    //16进制密钥
    private static final String KEY = "A8BCEFA5ABCEEB20A615BDCA9A7ABC2";
...
//            System.out.println(Sm4Util.verifyEcb(cipher, json));// true
            //解密
            phone = Sm4Util.decryptEcb(cipher);
            System.out.println(phone);
            long end = System.currentTimeMillis();
            System.out.println("end="+end);
            System.out.println("duaration="+(end-start));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
